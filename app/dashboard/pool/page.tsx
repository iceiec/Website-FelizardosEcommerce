...
import { poolEvents } from '@/lib/mock-data';
...
export default function PoolPage() {
  const [events, setEvents] = useState(poolEvents);
  ...
  const handleExportPDF = () => {
    ...
    if (printWindow) {
      const htmlContent = `
        <html>
          <head>
            <title>Pool Events Report</title>
            <style>
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-2">
              ...
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>{editingId ? 'Edit Event' : 'Schedule Pool Event'}</DialogTitle>
                    <DialogDescription>
                      {editingId ? 'Update the event details below' : 'Enter the event details to schedule your pool event'}
                    </DialogDescription>
                  </DialogHeader>
                                ...
                                <Dialog>
                                  ...
                                  <DialogContent>
                                    <DialogHeader>
                                      ...
                                      <DialogDescription>
                                        Complete information for this pool event booking
                                      </DialogDescription>
                                    </DialogHeader>
